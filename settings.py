...
params = {"Epoch": 1000,                # 单次仿真最大步数
          ...
          "target_update_period": 200,  # 目标网络更新周期
          "gamma": 0.95,                # 奖励的折扣因子
          "alpha": 0.001,
...
parser.add_argument("--alg_name", type=str, default="DQN", help="The algorithm name of training")
...
parser.add_argument("--assign_method", type=str, default="task_allocation", help="The method of assigning target")
parser.add_argument("--no_task", action="store_true", default=True, help="Don't use the task-assign")
